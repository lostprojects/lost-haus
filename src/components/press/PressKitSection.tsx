  ...
  return (
    <section className="py-16 bg-muted/40">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-header mb-6">Press Resources</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-all flex flex-col items-center">
            ...
            <h3 className="font-header text-xl mb-2">High-Res Images</h3>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-all flex flex-col items-center">
            ...
            <h3 className="font-header text-xl mb-2">Logo Assets</h3>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-all flex flex-col items-center">
            ...
            <h3 className="font-header text-xl mb-2">Press Information</h3>
