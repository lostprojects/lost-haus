...
function RevealImageListItem({ text, images }: ShowImageListItemProps) {
  ...
  return (
    <div className="group relative h-fit w-fit overflow-visible py-8">
      <h1 className="text-4xl md:text-7xl font-black text-foreground transition-all duration-500 group-hover:opacity-40 font-body">
        {text}
      </h1>
...
function RevealImageList() {
  ...
  return (
    <div className="flex flex-col gap-1 rounded-sm bg-background px-4 md:px-8 py-4 max-w-7xl mx-auto">
      <h3 className="text-sm font-black uppercase text-muted-foreground font-body mb-4">Our Event Types</h3>
